...
function trapeziumCalc(biggerBase, smallerBase, height) {
...
do {
  ...
  switch (option) {
    ...
    case 4:
      ...
      let trapeziumHeight = parseFloat(
        window.prompt("Enter the height value:")
      );
      let trapeziumResult = trapeziumCalc(
        biggerBase,
        smallerBase,
        trapeziumHeight
      );
      window.alert("The area of the trapezium is " + trapeziumResult + "!");
      break;
    case 5:
